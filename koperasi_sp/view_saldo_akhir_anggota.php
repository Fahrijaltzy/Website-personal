...
//$sql = "SELECT distinct anggota.id_anggota, anggota.nama,  anggota.smp_wajib+anggota.smp_pokok+simpanan.jumlah as saldo from anggota,simpanan";
$sql = " select nama, sum(jumlah) as saldo from simpanan a inner join anggota b on a.id_anggota = b.id_anggota group by nama";
