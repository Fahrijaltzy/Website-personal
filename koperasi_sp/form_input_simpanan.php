...
input[type=text],input[type=number], input[type=smp_wajib], input[type=smp_pokok],input[type=telepon], input[type=date]{
  width: 70%;
  padding: 15px;
  margin: 5px 0 22px 0;
...
<div id="main">
  <button class="openbtn" onclick="openNav()">☰ Menu</button>  
	<h1 align=center>Tambah dan Simpan Simpanan Baru</h1>
		<form action="input-simpanan.php" method="post" align=center>
			<div class="container">
			    <p>
			    	<label for="id_smp"><b>ID Simpanan</b></label>
			    	<input type="number" name="id_smp" id="id_smp">
			    </p>		    
			    <p>
			    ...
			    <p>
			    	...
			    	<input type="text" name="jns_simpanan" id="jns_simpanan">
			    </p>
			    <p>
...
<head>
	<title>Form Penambahan Simpanan Baru</title>
</head>
<body >
