...
<div id="main">
  <button class="openbtn" onclick="openNav()">☰ Menu</button>  
	<h1 align=center>Tambah dan Simpan Anggota Baru</h1>
		<form action="input_bayar.php" method="post" align=center>
			<div class="container">
			    <p>
			    ...
			    <p>
			    	<label for="smp_wajib">Simpanan Wajib</label>
			    	<input type="smp_wajib" name="smp_wajib" id="smp_wajib">
			    </p>
			    <p>
			    	<label for="smp_pokok">Simpanan Pokok</label>
			    	<input type="smp_pokok" name="smp_pokok" id="smp_pokok">
			    </p>
